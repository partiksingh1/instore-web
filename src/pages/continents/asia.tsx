...
const Asia = () => {
  ...
  const handleCountryClick = (country: string) => {
    ...
    navigate(`/${stores}/${category}/asia/${formattedCountry}`);
  };
  ...
  return (
    <StoresLayout>
     ...
     <Socials/>
      {/* Heading */}
      <h1 className="text-5xl md:text-5xl font-bold mt-4 md:-mt-12 text-center">ASIA</h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 relative z-10 p-12">
            {countriesInAsia.map((country) => (
              ...
              >
                ...
                {/* Text */}
                <span className="relative text-3xl font-bold text-white flex items-center justify-center h-full" style={{
